...
export const AffiliateSidebar: React.FC = () => {
    return (
        <aside className="w-64 bg-white dark:bg-gray-800 border-l border-gray-200 dark:border-gray-700 p-4 hidden lg:block">
            <h3 className="font-semibold mb-4 text-gray-700 dark:text-gray-300">Support Development</h3>
            ...
            <div className="space-y-4">
                <a
                    ...
                    className="block bg-gray-100 dark:bg-gray-700 p-4 rounded hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors border border-gray-300 dark:border-gray-600 hover:border-blue-500 group"
                >
                    ...
                    <h4 className="font-bold text-center text-gray-900 dark:text-white mb-1">Become a Sponsor</h4>
